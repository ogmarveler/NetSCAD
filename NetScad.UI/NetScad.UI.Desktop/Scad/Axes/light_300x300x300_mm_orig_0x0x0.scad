// Light_300x300x300_MM_Orig_0x0x0 Metric NetScad.Core Axis Module
...
module light_300x300x300_mm_orig_0x0x0(colorVal, alpha) {
 ...
 translate([-.875, -.875, z + .1]) rotate([90, 45, 135]) cube([0.2, 0.02, 1.25]);   }
         ...
         for (i = [0:20:300]){   if((i >= scale * .75 - .875 || i <= -scale * .75 + .875) && i != 0)
...
// End of Light_300x300x300_MM_Orig_0x0x0 Module
