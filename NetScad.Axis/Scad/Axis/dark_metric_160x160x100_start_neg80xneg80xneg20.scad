// Dark_Metric_160x160x100_Start_Neg80xNeg80xNeg20 Metric NetScad.Core Axis Module
...
module dark_metric_160x160x100_start_neg80xneg80xneg20(colorVal, alpha) {
 ...
 translate([-10, i + 0.875, .1]) linear_extrude(0.02) rotate(180) text(str(i/scale, unit), size=2);   }
         for (i = [-20:20:80]){   if((i >= scale * .75 - .875 || i <= -scale * .75 + .875) && i != 0)
 translate([-8.75, -8.75, i - .875]) rotate([0,45,135]) linear_extrude(0.02) rotate(90) text(str(i/scale, unit), size=1.75);   }
  }
}
// End of Dark_Metric_160x160x100_Start_Neg80xNeg80xNeg20 Module
