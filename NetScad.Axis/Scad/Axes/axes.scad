...
// Settings: UnitSystem=Imperial, MinX=0, MaxX=76.2, MinY=-76.2, MaxY=76.2, MinZ=-19.05, MaxZ=0
...
// Settings: UnitSystem=Imperial, MinX=-76.2, MaxX=76.2, MinY=-76.2, MaxY=76.2, MinZ=-19.05, MaxZ=76.2
...
// Settings: UnitSystem=Metric, MinX=-80, MaxX=80, MinY=-80, MaxY=80, MinZ=-20, MaxZ=80
...
// 3D Axis Module - Dark Metric 140x220x40 Start 0xNeg140xNeg40
// Calling Method: Get_Dark_Metric_140x220x40_Start_0xNeg140xNeg40();
// Settings: UnitSystem=Metric, MinX=0, MaxX=140, MinY=-140, MaxY=80, MinZ=-40, MaxZ=0
include <dark_metric_140x220x40_start_0xneg140xneg40.scad>;
module Get_Dark_Metric_140x220x40_Start_0xNeg140xNeg40(colorVal = "White", alpha = 1) {
  dark_metric_140x220x40_start_0xneg140xneg40(colorVal = colorVal, alpha = alpha);
}

// 3D Axis Module - Dark Imperial 5x8x1 Start 0xNeg5xNeg1
// Calling Method: Get_Dark_Imperial_5x8x1_Start_0xNeg5xNeg1();
// Settings: UnitSystem=Imperial, MinX=0, MaxX=127, MinY=-127, MaxY=76.2, MinZ=-31.75, MaxZ=0
include <dark_imperial_5x8x1_start_0xneg5xneg1.scad>;
module Get_Dark_Imperial_5x8x1_Start_0xNeg5xNeg1(colorVal = "White", alpha = 1) {
  dark_imperial_5x8x1_start_0xneg5xneg1(colorVal = colorVal, alpha = alpha);
}
