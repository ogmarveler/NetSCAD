...
// 3D Axis Module - Dark Imperial 24x4x7 Start Neg12xNeg4xNeg6
// Calling Method: Get_Dark_Imperial_24x4x7_Start_Neg12xNeg4xNeg6(colorVal, alpha);
// Settings: MeasureType=Imperial, MinX=-304.8, MaxX=304.8, MinY=-101.6, MaxY=0, MinZ=-152.4, MaxZ=19.05
include <dark_imperial_24x4x7_start_neg12xneg4xneg6.scad>;
module Get_Dark_Imperial_24x4x7_Start_Neg12xNeg4xNeg6(colorVal = "White", alpha = 1) {
  dark_imperial_24x4x7_start_neg12xneg4xneg6(colorVal = colorVal, alpha = alpha);
}

// 3D Axis Module - Dark Imperial 1x3x2 Start 0x0xNeg2
// Calling Method: Get_Dark_Imperial_1x3x2_Start_0x0xNeg2(colorVal, alpha);
// Settings: MeasureType=Imperial, MinX=0, MaxX=25.4, MinY=0, MaxY=76.2, MinZ=-50.8, MaxZ=12.7
include <dark_imperial_1x3x2_start_0x0xneg2.scad>;
module Get_Dark_Imperial_1x3x2_Start_0x0xNeg2(colorVal = "White", alpha = 1) {
  dark_imperial_1x3x2_start_0x0xneg2(colorVal = colorVal, alpha = alpha);
}

// 3D Axis Module - Light Metric 40x80x120 Start 0x0xNeg60
// Calling Method: Get_Light_Metric_40x80x120_Start_0x0xNeg60(colorVal, alpha);
// Settings: MeasureType=Metric, MinX=0, MaxX=40, MinY=0, MaxY=80, MinZ=-60, MaxZ=60
include <light_metric_40x80x120_start_0x0xneg60.scad>;
module Get_Light_Metric_40x80x120_Start_0x0xNeg60(colorVal = "Black", alpha = 1) {
  light_metric_40x80x120_start_0x0xneg60(colorVal = colorVal, alpha = alpha);
}
